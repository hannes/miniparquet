...
static uint32_t * nullunpacker16( uint32_t base,  uint32_t *  in , uint32_t * out) {
    for(int k = 0; k < 8; ++k) {
		 out[k] = base;
	}
	return in;
...
static uint32_t * nullunpacker32( uint32_t base,  uint32_t *  in , uint32_t * out) {
    for(int k = 0; k < 8; ++k) {
		 out[k] = base;
	}
	return in;
...
const static packfnc unpack8[33]= {nullunpacker8,unpack1_8,
                      unpack2_8,
                      unpack3_8,
                      unpack4_8,
                      unpack5_8,
